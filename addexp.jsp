...
<%@ page import="com.se.domain.experiment" %>
...
<head>
	...
	<script language="javascript" type="text/javascript">
        function check()
        {
            ...
            if(flag1==0){alert("实验标题不能为空!");}
            if(flag2==0){alert("实验要求不能为空!");}
            return false;
        }
	...
	<div class="main">
		...
		<div class="right">
			...
			<div style=" height: 500px;width:650px;float:left;">
				...
				<h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">新增实验</h1>
				</br>
				<div>
					<form class="bs-example bs-example-form" role="form" action="addexp.action" method="post"
						...
						<textarea class="form-control" rows="10" cols="50" name="requires"></textarea>
						<%--<span style="color:red;" id="s2"></span>--%>
						</div>
						<br />
						<button  class="btn btn-primary" onclick="return fun()" type="submit" value="提交">新增实验</button>
					</form>
				</div>
			</div>
		</div>

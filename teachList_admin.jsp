...
<%@page import="java.util.List,com.se.domain.teacher"%>
...
<div class="zhong">
    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">教师名单</h1>
            </br>
            <div style="margin-top: 10px;">
                <table class="table table-striped">
                    <tr>
                        <td ><strong>教师工号</strong></td>
                        <td ><strong>教师姓名</strong></td>
                        <td ><strong>教师性别</strong></td>
                        <td ><strong>上次登陆时间</strong></td>
                        <td><strong>操作</strong></td>
                    </tr>
                    <%
                        String status;
                        PageBean pageBean = (PageBean) request.getAttribute("teacherList"); //important!
                        List<teacher> teachers = pageBean.getData();
                    ...
                    <tr>
                        ...
                        <td><%=teacher.getLast_login()%></td>
                        <td>
                            <a onclick="return fun()"
                               href="delete_teacher_admin.action?deleteid=<%=teacher.getId()%>">删除</a>
                        </td>
                    </tr>
                ...
                <div class="page"
                    ...
                    <form name="PageForm" action="showTeacher_admin.action"
                          method="post">

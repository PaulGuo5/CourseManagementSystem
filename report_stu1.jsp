...
<div class="main supporting" id="zen-supporting" role="main">
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <div class="teacher" ; style="background: #ffffff; height: 1024px">
            <table class="teacher_table" width="100%">
                <tr>
                    <td class="td2"><font size=4> <%report rp=(report)request.getAttribute("report"); %>
                        报告标题：<%=rp.getTitle() %><br /></font></td>
                </tr>
                <tr>
                    <td class="td6">报告内容：<br /> <%=rp.getContent()%><br /></td>
                </tr>
                <tr>
                    <td class="td6"><div
                            style="text-align: right; size: 3; padding-right: 64px">
                        报告得分：
                            <%if(rp.getScore()<0) {%>
                        未评分
                            <% }
		...
		%>
                ...
                <tr>
                    <td class="td5"><font size=4"><div
                            style="text-align: right; size: 3">
                        报告提交时间：<%=rp.getTime() %></div></font></td>
                </tr>
        </div>
        <!--页脚-->

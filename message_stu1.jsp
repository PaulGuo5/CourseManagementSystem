...
<div class="main supporting" id="zen-supporting" role="main">
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <tr>
            ...
            <td valign="top"><table width="100%" height="31" border="0"
                ...
                <tr>
                    ...
                    <td height="31" width="130"><div class="titlebt">
                        <a href="showmessage_stu.action"><font color="#00AEAE">交流天地</a>
                    </div></td>
        ...
        <div style="background: #ffffff; height: 1024px">
            <form
                    action="submitmessage_stu.action?msgerid=${sessionScope.value}"
                    method="post">
					<textarea class="comment" rows="2" cols="100" name="msg"
                              style="position: relative; top: 20px; left: 150px;"></textarea>
                <br /> <input type="submit" value="留言"
                              style="position: relative; top: 20px; left: 150px;" /><br />
            </form>
            <table width="60%" ID="message_table"
                ...
                <tr>
                    <td class="td0">--</td>
                    <td class="td0"><font size=3><%=mess.getAuthor_name()%></font></td>
                    <td class="td0"><font size=3><%=mess.getContent()%></font></td>
                    <td class="td0"><font size=3><%=mess.getTime()%></font></td>
                    <td class="td0"><font size=6 color=white>×</font></td>
                </tr>
            ...
            <div class="page"
                 style="text-align: center; position: relative; top: 50px; left: -200px;">
                <font size=3>
                    <form name="PageForm" action="showmessage_stu.action"
                          method="post">

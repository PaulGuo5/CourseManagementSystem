        ...
        <div class="right">
            <div class="right_title" style="font-size: 40px;"><b>面向大规模用户的师生课程管理系统</b>
                ...
                <div style="margin-top: 10px;height: 300px;">
                    ...
                    <form class="form-horizontal" action="insert_student_admin.action" method="post"
                          style="font-size:14px;" name="myform" onsubmit="return fun();">
                        <div class="form-group">
                            <label for="inputId" class="col-sm-2 control-label">学号</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputId" placeholder="ID" name="student.id"
                                       style="width: 80%;height: 40px;" onblur=IsNum(this)>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" placeholder="Name"
                                       name="student.name" style="width: 80%;height: 40px;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputClass" class="col-sm-2 control-label">班级</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputClass" placeholder="ClassNumber"
                                       name="student.class_number" style="width: 80%;height: 40px;" onblur=IsNum1(this)>
                            </div>
                        </div>
                        <div class="form-group">

	...
	<div class="main">
		...
		<div class="right">
			...
			<div style=" height: 500px;width:650px;float:left;">
				...
				<%----%>
				<h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">教学实验</h1>
				<br />
				<div style="overflow:scroll;height:450px;weight:400px;">
				<table class="table table-striped">
					<tr>
						<td ><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span> 实验名</td>
					</tr>
					<%
					...
					<tr>
						<td>
							<a href="detailexp_stu.action?detail_id=<%=student.getId()%>&stu_id=${sessionScope.value}"><%=student.getExperiment()%></a>
						</td>
					</tr>
					<%
						}

	...
	<div class="main supporting" id="zen-supporting" role="main">
		<div class="explanation" id="zen-explanation" role="article">
				...
				<td valign="top"><table width="100%" height="31" border="0"
						...
						<tbody>
							<tr>
								...
								<td height="31" width="130"><div class="titlebt">
										<a href="showfile_stu.action"><font color="#00AEAE">下载课件</a>
									</div></td>
								<td height="31" width="130"><div class="titlebt">
			...
			<div style="background: #ffffff; height: 1024px">
				<h1 align="center" style="position: relative; top: 20px;">课件</h1>
				<div class="course">
					<%
           String sss;
			...
			%>
					...
					<img src="images/ppt1.gif" height="30" width="30"/>
					<font size=3
						style="line-height: 60px; position: relative; left: 40px;"><a
						href="download.action?fileName=<%= i%>"><%= str[i]%></a></font><br />
					<%
				}
			}
		%>

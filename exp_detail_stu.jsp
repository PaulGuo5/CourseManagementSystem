		...
		<div class="right">
			...
			<div style=" height: 500px;width:650px;float:left;">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> 实验标题：<%=request.getAttribute("experiment") %></div>
					<div class="panel-body"> 实验要求：<%=request.getAttribute("requires") %></div>
					<%int flag=(int) request.getAttribute("flag");
						if(flag==0)
						{
					%>
					<div class="panel-body"> 你还未提交作业，请点此提交 <a
							href="report_submit.jsp?stu_id=${sessionScope.value}&expid=<%=request.getAttribute("detail_id") %>">提交作业</a></div>
					<% }
					else
					{
					%>
					<div class="panel-body">你已提交作业，点此查看 <a
							href="show_report.action?stu_id=${sessionScope.value}&expid=<%=request.getAttribute("detail_id") %>">查看作业</a></div>
					<%} %>
				</div>
			</div>
		</div>

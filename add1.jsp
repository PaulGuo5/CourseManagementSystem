...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
            var flag1=1,flag2=1;
            if(document.getElementsByName("student.id")[0].value==""){
                flag1=0;
            }
            if(document.getElementsByName("student.name")[0].value==""){
                flag2=0;
            }
            if(flag1==1&&flag2==1){
                return true;
            }
            if(flag1==0){document.getElementById("s1").innerHTML="学生学号不能为空";}
            if(flag2==0){document.getElementById("s2").innerHTML="学生姓名不能为空";}
            return false;
        }
    </script>
</head>

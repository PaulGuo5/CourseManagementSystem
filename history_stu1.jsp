...
<div class="main supporting" id="zen-supporting" role="main">
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <div style="background: #ffffff; height: 1024px">
            ...
            <h1 align="center" style="position: relative; top: 20px;">历史记录</h1>

            <table width="80%" class="student_table"
                   style="position: relative; top: 20px; left: 100px;">
                <tr>
                    <td class="td1"><font size=3>学生姓名</font></td>
                    <td class="td1"><font size=3>操作内容</font></td>
                    <td class="td5"><font size=3>操作时间</font></td>
                </tr>
                ...
                %>
                <tr>
                    <td class="td3"><font size=3><%=hs.getOperator()%></font></td>
                    <td class="td3"><font size=3><%=hs.getContent()%></font></td>
                    <td class="td4"><font size=3><%=hs.getTime()%></font></td>
                </tr>

            ...
            <div style=" height: 500px;width:700px;float:left;">
                ...
                <div style="overflow:scroll;height:450px;weight:400px;">
                    <form action="practice_stu_result.action" id="myForm" method="post"
                          onsubmit="return check();" style="min-height:600px;">
					<input type="hidden" name="id" value=<%=(int) session.getAttribute("value") %> />
                    <%
                        int i = 0;
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"><%=++i%>、<%=student.getSubject()%>
                        </div>
                        <br/>
                        <div class="panel-body">
                            <font size=3 style="line-height: 32px;"><input
                                    ...
                                    value="<%=student.getSubject()%>"/></font> <font size=3
                                                                                     style="line-height: 32px;"><input
                                name="no[<%=i %>]"
                                type="radio" value="A"/>A、<%=student.getA()%>
                        </font> <font size=3
                                      style="line-height: 32px;"><input name="no[<%=i %>]"
                                                                        type="radio" value="B"/>B、<%=student.getB()%>
                        </font><br/> <font size=3
                                           style="line-height: 32px;"><input name="no[<%=i %>]"
                                                                             type="radio"
                                                                             value="C"/>C、<%=student.getC()%>
                        </font> <font size=3
                                      style="line-height: 32px;"><input name="no[<%=i %>]"
                                                                        type="radio" value="D"/>D、<%=student.getD()%>
                        </font> <font size=3
                                      style="line-height: 32px;"><input name="exid[<%=i %>]"
                                                                        type="hidden"
                                                                        value="<%=student.getId()%>"/></font> <font
                                size=3
                                style="line-height: 32px;"><input name="as[<%=i %>]"
                                                                  type="hidden"
                                                                  value="<%=student.getAnswer()%>"/></font><br/>
                        </div>
                    </div>

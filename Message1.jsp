...
<div class="main supporting" id="zen-supporting" role="main">
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <tr>
            ...
            <td valign="top"><table width="100%" height="31" border="0"
                ...
                <tr>
                    ...
                    <td height="31" width="130"><div class="titlebt">
                        <a href="showmessage.action"><font color="#00AEAE">交流天地</a>
                    </div></td>
        ...
        <div style="background: #ffffff; height: 1024px">
            <div class="message" style="position: relative; left: 100px;">
                <form action="submitmessage.action?msgerid=${sessionScope.value}"
                      method="post">
						<textarea class="comment" rows="2" cols="120" name="msg"
                ...
                <table width="60%" ID="message_table"
                    ...
                    <tr>
                        ...
                        <td class="td0"><a onclick="return fun()"
                                           href="deletemessage.action?deleteid=<%=mess.getId()%>"><font

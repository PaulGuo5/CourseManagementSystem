    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style=" height: 500px;width:650px;float:left;">
                <h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">提交报告</h1>

                <div style="color: #337ab7;font-size: 18px;"><strong>提交实验<%=request.getParameter("expid")%>报告</strong>
                </div>
                <br/>
                <form action="addreport.action" method="post" onsubmit="return check();">
                    <div class="form-group"style="color: #337ab7;font-size: 15px;"><strong>报告标题</strong></div>
                    <div><input class="form-control" type="text" name="title"/><span style="color:red;" id="s1"></span><br/></div>
                    <br/>
                    <div class="form-group"style="color: #337ab7;font-size: 15px;"><strong>报告内容</strong></div>
                    <div><textarea class="form-control" rows="10" cols="50" name="content"></textarea><span style="color:red;"
                                                                                       id="s2"></span><br/></div>
                    ...
                    <br/>
                    <button type="submit" class="btn btn-primary" onclick="return fun()" value="提交">提交报告</button>
                </form>
            </div>
        </div>

...
<head>
    ...
    <script language="javascript" type="text/javascript">
        function check()
        {
            ...
            if(flag1==0){document.getElementById("s1").innerHTML="标题不能为空";}
            if(flag2==0){document.getElementById("s2").innerHTML="大纲内容不能为空";}
            if(flag3==0){document.getElementById("s3").innerHTML="年份不能为空";}
            return false;
        }
            ...
            <tr>
                ...
                <td valign="top"><table width="100%" height="31" border="0"
                    ...
                    <tr>
                        ...
                        <td height="31" width="130"><div class="titlebt">
                            <a href="teach.action"><font color="#00AEAE">教学大纲</a>
                        </div></td>
                        <td height="31" width="130"><div class="titlebt">
                ...
                <div class="teacher">
                    <form action="addteach.action" method="post"
                        ...
                        <p style="font-size: 20px;">
                            大纲标题&nbsp;<input type="text" name="title"
                                             style="font-size: 20px; border: 1px solid black;" /><span
                                id="s1"></span>
                        </p>
                        <br />
                        <p style="font-size: 20px;">
                            大纲内容&nbsp;<br />
                            <textarea rows="16" cols="50" name="content"
                                      style="border: 1px solid black; position: relative; left: 80px;"></textarea>
                            <span id="s2"></span>
                        </p>
                        <br />
                        <p style="font-size: 20px;">
                            大纲年份&nbsp;<input type="text" name="year"
                                             style="font-size: 20px; border: 1px solid black;" /><span
                                id="s3"></span>
                        </p>
                        <br />

        ...
        <div class="explanation" id="zen-explanation" role="article">
            ...
            <div style="background: #ffffff; height: 1024px">
                ...
                <form action="updateexp.action" method="post">
                    实验标题<input type="text" name="experiment"
                               value="<%=exp.getExperiment()%>" /><br /> 实验要求
                    <textarea rows="16" cols="50" name="requires"><%=exp.getRequires()%></textarea>
                    <br /> <input type="hidden" name="expid" value="<%=exp.getId() %>" />

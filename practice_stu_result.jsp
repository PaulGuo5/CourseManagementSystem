...
<%@page import="java.util.List,com.se.domain.result"%>
<%@ page import="com.se.domain.practice" %>
<%
	...
	<div class="main">
		...
		<div class="right">
			...
			<div style=" height: 500px;width:700px;float:left;">
				...
				<h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">练习结果</h1>
				</br>
				<%
					List<result> results =(List<result>) request.getAttribute("result");
					int sum =(int) request.getAttribute("mark");
					int s=sum*10;
				%>
				<p style="color:#337ab7;"><strong>本次练习的正确率为：</strong></p>
				<div class="progress">
				...
				{
				%>
				<p style="color:#337ab7;text-align:center;font-size:20px;"><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span><strong>恭喜你！你答对了全部题目！！！</strong></p>
				<%
				}
				else
				{
				...
				<div style="overflow:scroll;height:400px;weight:400px;">
					<div class="panel panel-default" style="height-min: 400px">
						<p style="color:#337ab7;font-size:20px;"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span><strong>本次练习共10题，其中答对<%= sum %>题，答错<%= 10-sum %>题，错题如下：<br /></strong></p>
						<%
							int i=1;
						...
						<%= i++%>、题目:<%=rs.getQuestion() %><br />
						</div>
						<div class="panel-body">
							<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>你选的是：<%=rs.getChoose_id() %>
						:
						<%=rs.getChoose_text() %><br />
						</div>
						<div class="panel-body">
							<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>正确答案是：<%=rs.getRight_id() %>
						:
						<%=rs.getRight_text() %><br />
						</div>
						<%

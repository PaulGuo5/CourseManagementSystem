        ...
        <div id="blog-calendar" style="">
            <table id="blogCalendar" class="Cal" cellspacing="0" cellpadding="0"
                ...
                <tr>
                    ...
                    <td class="CalWeekendDay" align="center"><a>1</a></td>
                </tr>
                <tr>
                    <td class="CalWeekendDay" align="center"><a>2</a></td>
    ...
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <div style="background: #ffffff; height: 1024px">
            ...
            <div class="exp_detail">
                <font size=3 style="line-height: 32px;"> 实验标题：<%=request.getAttribute("experiment") %></font><br />
                <font size=3 style="line-height: 32px;"> 实验要求：<%=request.getAttribute("requires") %></font><br />
                ...
                <table width="60%"
                       style="font-size: 15px; position: relative; top: 50px;">
                    <tr>
                        <td>报告标题</td>
                        <td>提交者</td>
                        <td>分数</td>
                ...
                {%>
                <font size=3
                      style="text-align: center; position: relative; top: 50px;">当前尚未有人提交报告。</font>
                <%} %>
            </div>
        </div>
        <!--页脚-->

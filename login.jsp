...
<link rel="stylesheet" href="./css/style.css?1" media="screen"
	type="text/css" />
				...
				<div class="switch-wrap switch-wrap-signin active">
					<ul class="wall-form-ipt-list">
						...
						<li><input type="password" placeholder="请输入密码" value=""
							...
							id="lPassword"><span style="color:white;" id="s1"></span><span style="color:white;" id="s2"></span>
						</li>
					</ul>
					...
					<input type="submit" class="wall-sub-btn"
						style="position: relative;" value="登录" onsubmit="return check();">
				</div>
			</div>

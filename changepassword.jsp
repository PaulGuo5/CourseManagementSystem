...
<head>
    ...
    <script src="css/jquery-3.2.1/jquery-3.2.1.js"></script>
    <script src="css/jquery-3.2.1/jquery-3.2.1.min.js"></script>
    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style=" height: 500px;width:700px;float:left;">
                ...
                <h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">修改密码</h1>
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td><% int pwdid = (int) request.getAttribute("oldpassword"); %>${sessionScope.value}</td>
                ...
                <%--<br />--%>
                <form class="bs-example bs-example-form" role="form" action="submitpw.action" method="post"
                      onsubmit="return check();" name="myform">
                    <div class="input-group">
                        <input class="form-control" type="hidden" name="id"
                               value="<%=(int)request.getAttribute("changeid") %>"/>
                        <input class="form-control" type="hidden" name="pw" id="pw" value="<%=pwdid %>"/>
                        <div>请输入旧密码： </div>
                    ...
                    <div class="input-group">
                        <div>请再次输入新密码：</div>
                        <input class="form-control" type="password" name="nnewpw" id="nnewpw"/>
                    </div>
                    <br/></br>

                    <div style="text-align: center">
                        <button name="btn" type="submit" class="btn btn-primary" onclick="return fun()">修改密码</button>
...
<script type="text/javascript" src="css/meun.js"></script>
</html>

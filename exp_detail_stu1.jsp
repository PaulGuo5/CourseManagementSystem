...
<div class="page-wrapper">
    <div class="information_bg">
        <div class="information">
            ...
            <p>
                <font size=3> <a
                        href="changepw.action_stu?changeid=${sessionScope.value}">修改密码</a></font>
            </p>
            <p>
                <font size=3><a
    ...
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <tr>
            ...
            <td valign="top"><table width="100%" height="31" border="0"
                ...
                <tr>
                    ...
                    <td height="31" width="130"><div class="titlebt">
                        <a href="showexp_stu.action"><font color="#00AEAE">教学实验</a>
                    </div></td>
                    <td height="31" width="130"><div class="titlebt">
        ...
        <div style="background: #ffffff; height: 1024px">
            <div class="exp_detail">
                <font size=3 style="line-height: 72px;"> 实验标题：<%=request.getAttribute("experiment") %></font><br />
                <font size=3 style="line-height: 72px;"> 实验要求：<%=request.getAttribute("requires") %></font><br />
                <%int flag=(int) request.getAttribute("flag");
                    if(flag==0)
                    {
                %>
                <font size=3> 你还未提交作业，请点此提交 <a
                        href="report_submit.jsp?stu_id=${sessionScope.value}&expid=<%=request.getAttribute("detail_id") %>">提交作业</a></font>
                <% }
                else
                {
                %>
                <font size=3>你已提交作业，点此查看 <a
                        href="show_report.action?stu_id=${sessionScope.value}&expid=<%=request.getAttribute("detail_id") %>">查看作业</a></font>
                <%} %>
            </div>
        </div>
        <!--页脚-->

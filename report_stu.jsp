	...
	<div class="main">
		...
		<div class="right">
			...
			<div style=" height: 500px;width:650px;float:left;">
				<h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">查看实验</h1>
				<br />

				<div class="panel panel-default">
					<div class="panel-heading"> <%report rp=(report)request.getAttribute("report"); %>
						<strong>报告标题：<%=rp.getTitle() %></strong></div>
					<div style="overflow:scroll;height:400px;weight:500px;">
						<div style="min-height:300px;">
							<div class="panel-body"> <strong>报告内容：</strong><%=rp.getContent()%></div>
					<div class="panel-body" style="text-align: right;"><strong>报告得分：</strong>
						<%if(rp.getScore()<0) {%>
						未得分
						<% }
						else
						...
						<% }%>
							...
							<div class="panel-body" style="text-align: right;"><strong>报告提交时间：</strong><%=rp.getTime() %></div>
				    </div>
					</div>
				</div>
			</div>

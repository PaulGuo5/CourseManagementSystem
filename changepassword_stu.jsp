    ...
    <div class="main">
        ...
        <div class="right">
            ...
            <div style=" height: 500px;width:700px;float:left;">
                ...
                <%--<br />--%>
                <form class="bs-example bs-example-form" role="form"action="submitpw_stu.action" method="post"
                    ...
                    <div style="text-align: center">
                        <button type="submit" class="btn btn-primary" onclick="return fun()">修改密码</button>

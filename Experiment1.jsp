    ...
    <div class="main supporting" id="zen-supporting" role="main">
        <div class="explanation" id="zen-explanation" role="article">
            ...
            <div style="background: #ffffff; height: 1024px">
                <a href="addexp.jsp" class="button grey">新增实验</a>
                <h1 align="center" style="position: relative; top: 20px;">课程实验</h1>
                <div class="experiment">
                    ...
                    <font size=3 style="line-height: 50px;"><a
                            href="detailexp.action?detail_id=<%=student.getId()%>"><%=student.getExperiment()%></a></font><br />

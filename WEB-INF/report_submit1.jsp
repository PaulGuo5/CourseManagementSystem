...
<div class="main supporting" id="zen-supporting" role="main">
    <div class="explanation" id="zen-explanation" role="article">
        ...
        <div style="background: #ffffff; height: 1024px">
            <p>
                提交实验<%=request.getParameter("expid")%>报告
            </p>
            <form action="addreport.action" method="post">
                报告标题<input type="text" name="title" /><br /> 报告内容
                <textarea rows="16" cols="50" name="content"></textarea>
                <br /> <input type="hidden" name="stu_id"
                              value="<%=request.getParameter("stu_id") %>" /> <input
                    type="hidden" name="expid"
                    value="<%=request.getParameter("expid") %>" /> <input

		...
		<div class="right">
			<div class="right_title"  style="font-size: 40px;" ><b>面向大规模用户的师生课程管理系统</b>
				...
				<div style=" height: 500px;width:650px;float:left;">
					...
					<h1 align="center" style="position: relative;font-size: 25px;color: #01548e; ">课件列表</h1>
					...
					<table class="table table-striped">
						<tr>
							<td ><span class="glyphicon glyphicon-save" aria-hidden="true"></span><strong>课件名</strong></td>
							<td ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span><strong>操作</strong></td>
						</tr>
						<%
							String sss;
						...
						<tr>
							<td>
								<img src="images/ppt1.gif" height="30" width="30"/>&nbsp;&nbsp;<a href="download.action?fileName=<%= i%>"><%= str[i]%></a>
							</td>
							<td>
								<a onclick="return fun()" href="deletefile?fileName=<%= i%>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除</a>
							</td>
						</tr>
						<%
								}

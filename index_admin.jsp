        ...
        <div class="right">
            <div class="right_title"  style="font-size: 40px;" ><b>面向大规模用户的师生课程管理系统</b>
                ...
                <div  style="float:left;height:450px;">
                    <div style="line-height: 1.5; letter-spacing: 4px;font-size: 16px;">&nbsp;&nbsp;&nbsp;&nbsp; 管理员能够对学生名单进行管理，增加和删除学生信息；也有权限对教师名单的管理，进行增加和删除教师的信息；还有对交流天地的管理，查看和删除留言板的内容。
                        <br><br><br><br>
                        <div class="news">
                            <div class="news_title"><span><img src="images/title_1.gif" /></span><a href="showmessage_admin.action"><img src="images/more.gif" /></a></div>
                        <div><img src="images/fzulib.jpg" width=550px height=300px/></div>
                        </div>
                    </div>
                </div>
            </div>
